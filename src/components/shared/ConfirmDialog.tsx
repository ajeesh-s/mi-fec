...
const ConfirmDialog: React.FC<IConfirmDialogProps> = (props) => {
    ...
    const footer = (
        <React.Fragment>
            <Button label="No" size="small" icon="pi pi-times" outlined onClick={closeClick} />
            <Button label="Yes" size="small" icon="pi pi-check" severity="danger" onClick={confirmClick} />
        </React.Fragment>
    );
